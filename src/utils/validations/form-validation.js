...
export const bankDetailSchema = z
  .object({
    ...
    reconfirmedBankAccountNumber: z
      .string()
      .trim()
      .min(1, "Please reconfirm your account number"),
  ...
  .refine(
    (data) => data.bankAccountNumber === data.reconfirmedBankAccountNumber,
    {
      message: "Account numbers do not match",
      path: ["reconfirmedBankAccountNumber"], // shows error under the confirm field
    }
  );