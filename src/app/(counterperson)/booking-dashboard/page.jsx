...
import {
  ...
  useSearchBusesQuery,
} from "@/utils/redux/api/consumerApi/consumerBusSlice";
...
const OfflineBookingPage = () => {
  ...
  const [travelDate, setTravelDate] = useState(tomorrowDate);
  ...
  const searchRoutes = async () => {
    ...
    try {
      ...
      response.schedule && setRoutes(response.schedule);
      setStep(2);
      setError("");
    } catch (error) {
      console.error(
        "Failed to fetch bus schedule:",
  ...
  const renderStep1 = () => {
    ...
    return (
      <div className="bg-white rounded-[12px] p-6 shadow max-w-7xl animate-fadeInUp">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative">
            <div className="pb-10 md:pb-0 lg:pb-0">
              ...
              <input
                ...
                className="w-full md:w-100 p-2 border border-slate-200 rounded-lg text-sm focus:outline-[#007bff33] focus:ring focus:ring-[#004aad]"
              />
            </div>
            ...
            <button
              ...
              className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 
               bg-white border border-slate-300 rounded-full p-2 mt-3 shadow-md 
               hover:bg-slate-100 transition"
            >
              <FaExchangeAlt className="text-[#004aad] text-lg" />
            </button>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2 px-6 py-2 bg-gradient-to-r from-[#003c89] via-[#004aad] to-[#0051ba]  text-white rounded-lg hover:bg-[#00348a] transition cursor-pointer disabled:opacity-50"
          >
            <FaSearch />
  ...
  const renderStep2 = () => {
    return (
      <div className="bg-white rounded-[12px] px-2 py-2 shadow max-w-4xl mx-auto animate-fadeInUp">
        <h2 className="text-[#004aad] mb-4 text-lg font-semibold flex items-center gap-2">
        ...
        <div className="space-y-4">
          {Array.isArray(routes) && routes.length > 0 ? (
            routes.map((route, key) => (
              ...
              >
                <div className="flex flex-row row-end-2 justify-between">
                  <div className="text-left">
                    <div className="flex flex-col gap-3">
                      <h3 className="font-semibold text-[#004aad] ">
                        {route.busName} {/* Instead of route.busId.busName */}
                      </h3>
                      ...
                      <p className="text-sm text-gray-500 gap-1.5 flex item-center">
                  ...
                  <div className="text-right">
                    <div className="flex flex-col gap-2">
                      <p className="font-semibold text-[#004aad] flex items-center gap-1">
                        <FaRupeeSign />
                        {route.price} {/* Instead of route.basePrice */}
                      </p>

                      <button
                        onClick={() => selectRoute(route)}
                        className="px-4 py-2 bg-[#004aad] text-white rounded-lg hover:bg-[#00348a] transition cursor-pointer text-[0.75rem] md:text-sm"
                      >
                        Select Route
                      </button>
                    </div>
          ...
          <>
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-500">
                {seatLayout.route.departureTime} -{" "}
                {seatLayout.route.arrivalTime}
              </p>
